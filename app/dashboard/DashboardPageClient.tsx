  ...
  return (
    <div className="min-h-screen p-8 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
      ...
      <div className="mb-10 flex flex-wrap gap-4 items-center justify-center">
        ...
        <button
          ...
          className={`px-6 py-3 rounded-xl text-white font-semibold transition transform hover:scale-105 ${
            uploading ? "bg-gray-500 cursor-not-allowed" : "bg-gradient-to-r from-violet-500 to-fuchsia-500 hover:shadow-lg"
          }`}
          disabled={uploading}
        >
      ...
      {uploading && (
        <div className="w-full mt-4">
          <div className="w-full bg-gray-800 rounded-full h-4 overflow-hidden">
            <div className="bg-gradient-to-r from-violet-500 to-fuchsia-500 h-4 transition-all duration-300" style={{ width: `${progress}%` }} />
          </div>
      ...
      <form onSubmit={handleSearch} className="mb-10 flex gap-3 justify-center">
        ...
        />
        <button type="submit" className="bg-gradient-to-r from-violet-500 to-fuchsia-500 px-6 py-2 rounded-xl font-semibold text-white hover:shadow-lg transition">
          Search
        </button>
      </form>
